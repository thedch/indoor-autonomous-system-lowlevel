...
#define LEFT_ENCODER_PIN1 34 // TODO: Why are there duplicate #defines from the other .ino file?
...
Encoder myEnc1(LEFT_ENCODER_PIN1, LEFT_ENCODER_PIN2); // Left Encoder // TODO: If it''s the left encoder, why not just call it that?
...
enum WheelState WheelCurrentState = Moving; // why do we have snake case and camel case in the same codebase?
